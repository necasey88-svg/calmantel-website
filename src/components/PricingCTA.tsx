...
export default function PricingCTA() {
  return (
    <section className="bg-[#F9F7F3] border-t border-[color:var(--sand-deep)] py-20 text-center">
      ...
      >
        Plan your fireplace project with confidence.
      </h2>
      <p className="text-[color:var(--ink)]/60 text-base max-w-xl mx-auto mb-9 leading-relaxed">
        Share the project details you have now and our team will help shape the right
        mantel, fireplace, installation path, and starting range.
      </p>
      <Link
        href="/estimate"
