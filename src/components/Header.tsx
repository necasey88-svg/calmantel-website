...
const fireplaceMenu: MegaMenuProps["columns"] = [
  {
    ...
    links: [
      ...
      { label: "Fireplace Accessories", href: "/fireplaces/accessories", description: "Decorative Chimney Shrouds" },
    ],
  },
  {
...
export default function Header() {
  ...
  return (
    <header className="bg-[#F9F7F3]/95 backdrop-blur sticky top-0 z-50 border-b border-[color:var(--sand-deep)]">
      ...
      {/* Mobile menu. max-h + overflow keeps the 27-link list scrollable inside
          the sticky header — without it, items below the fold are unreachable on
