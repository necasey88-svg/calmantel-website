...
const sacramentoFireplaces: Omit<OverstockFireplace, "location">[] = [
  ...
  },
  {
    ...
    sku: "DVLL48SP90N",
    image: "/overstock/dvll48sp90n.webp",
    quantity: 1,
    category: "Gas",
  ...
  },
  {
    ...
    sku: "ODLANAIG-51",
    image: "/overstock/odlanaig51.jpg",
    quantity: 1,
    category: "Outdoor",
  ...
  },
  {
    ...
    image: "/overstock/drl2035ten.png",
    quantity: 3,
    category: "Gas",
    configuration: "Front-facing linear",
    fuel: "Natural gas",
  ...
  },
  {
    ...
    image: "/overstock/drt2045den.jpg",
    quantity: 5,
    category: "Gas",
  ...
  },
  {
    ...
    image: "/overstock/drt3035den.jpg",
    quantity: 2,
    category: "Gas",
    configuration: "Front-facing traditional",
    fuel: "Natural gas",
  ...
  },
  {
    ...
    image: "/overstock/drt3535den.jpg",
    quantity: 1,
    category: "Gas",
    configuration: "Front-facing traditional",
    fuel: "Natural gas",
  ...
  },
  {
    ...
    image: "/overstock/drt40crden.jpg",
    quantity: 1,
    category: "Gas",
  ...
  },
  {
    ...
    sku: "SF-WM58-BK",
    image: "/overstock/sf-wm58-bk.jpg",
    quantity: 1,
    category: "Electric",
  ...
  },
  {
    ...
    sku: "CFL-30NG-C",
    image: "/overstock/cfl-30ng-c.jpg",
    quantity: 1,
    category: "Gas Log Set",
    configuration: "Vented log set",
    fuel: "Natural gas",
  ...
  },
  {
    ...
    image: "/overstock/odlvf48zen.jpg",
    quantity: 1,
    category: "Outdoor",
    configuration: "Front-facing linear",
    fuel: "Natural gas",
  ...
  },
  {
    ...
    image: "/overstock/vre4342zen.jpg",
    quantity: 12,
    category: "Outdoor",
    configuration: "Outdoor firebox",
    fuel: "For compatible gas log set",
  ...
  },
  {
    ...
    image: "/overstock/wrt3042wsi.jpg",
    quantity: 1,
    category: "Wood-Burning",
    configuration: "Built-in wood-burning",
    fuel: "Wood",
...
const anaheimFireplaces: AnaheimInventoryItem[] = [
  ...
  },
  {
    ...
    sku: "8000CL-IFT-S",
    image: "/overstock/8000cl-ift-s.jpg",
    quantity: 1,
    category: "Gas",
    configuration: "Front-facing",
    fuel: "Gas configuration to confirm",
  ...
  },
  {
    ...
    sku: "SF-FM50-WH",
    image: "/overstock/sf-fm50-wh.jpg",
    quantity: 1,
    category: "Electric",
  ...
  },
  {
    ...
    sku: "SF-FM60-WH",
    image: "/overstock/sf-fm60-wh.jpg",
    quantity: 1,
    category: "Electric",
    configuration: "Wall-mount / built-in",
    fuel: "Electric",
  ...
  },
  {
    ...
    sku: "NEFB50H-3SV",
    image: "/overstock/nefb50h-3sv.png",
    quantity: 1,
    category: "Electric",
