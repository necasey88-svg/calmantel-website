...
export default function HeatAndGloPage() {
  const category = getFireplaceCategory("heat-and-glo");
          ...
          {category.products.map((product, i) => (
            <div key={i} className="border border-stone-200 rounded-sm overflow-hidden hover:border-[color:var(--accent)] hover:shadow-sm transition-all group flex flex-col">
              ...
              <div className="p-7 flex flex-col flex-1">
                <h2 className="text-xl font-medium text-stone-900 mb-2 group-hover:text-[color:var(--accent)] transition-colors" style={{ fontFamily: "var(--font-playfair)" }}>
                  {product.name}
                </h2>
